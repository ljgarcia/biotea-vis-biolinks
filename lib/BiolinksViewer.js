...
var initAnnotationViewers = function(viewer) {
    ...
    var tableContainer = viewer.annotationGroupDiv.append('table').append('tr');

    viewer.annotationViewerReference = {};
    viewer.annotationReferenceTable = tableContainer.append('td').attr('width', '50%').append('table')
    ...
    viewer.annotationViewerCompared = {};
    viewer.annotationComparedTable = tableContainer.append('td').attr('width', '50%').append('table')
        .attr('width', '100%').style('display', 'none');
...
var updateSimilarity = function(viewer) {
    ...
    var data = viewer.parser.calculateSimilarity(queryArticle, relatedIds);
    ...
    viewer.similarityViewer.viewer = simil;
